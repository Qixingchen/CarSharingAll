...
public class ArrangementDetailActivity extends Activity {
	...
	private String startDate,endDate,startTime,endTime,weekrepeat,mdealstatus;
	private int Date[];
	private ImageView fanhui;
	private Button reorder;
	private SimpleDateFormat standard_date, standard_time, primary_date, primary_date1, primary_time;
	private Date test_date = new Date();
	private String primary_short_startdate = null, primary_short_starttime = null, primary_short_endtime = null,
	               primary_commute_startdate = null, primary_commute_starttime = null, primary_commute_endtime = null,primary_commute_enddate=null,
...
//		}
		...
		reorder.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				if (carsharing_type.compareTo("shortway") == 0) {
					Intent shortway = new Intent(ArrangementDetailActivity.this,
					...
					try{
						...
						primary_short_endtime = primary_time
								.format(test_date);
					}catch (ParseException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
					}
					shortway.putExtra("re_short_startdate", primary_short_startdate);
					shortway.putExtra("re_short_starttime", primary_short_starttime);
					...
					commute.putExtra("re_commute_startdate", primary_commute_startdate);
					commute.putExtra("re_commute_enddate", primary_commute_enddate);
					commute.putExtra("re_commute_starttime", primary_commute_starttime);
					commute.putExtra("re_commute_endtime", primary_commute_endtime);
					...
					longway.putExtra("re_longway_startdate", primary_longway_startdate);
