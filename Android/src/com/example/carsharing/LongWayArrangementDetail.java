...
public class LongWayArrangementDetail extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TextView sp = (TextView) findViewById(R.id.long_arrangementdetail_startaddress),
				ep = (TextView) findViewById(R.id.long_arrangementdetail_endaddress),
				st = (TextView) findViewById(R.id.long_arrangementdetail_starttime),
				rs = (TextView) findViewById(R.id.long_arrangementdetail_remainsites);
		...
		StringRequest stringRequest = new StringRequest(Request.Method.POST,
				...
				new Response.Listener<String>(){
					...
					public void onResponse(String response) {
						...
						try {
							TextView username = (TextView) findViewById(R.id.long_arrangementdetail_name),
									usergender = (TextView) findViewById(R.id.long_arrangementdetail_gender),
									userintro = (TextView) findViewById(R.id.long_arrangementdetail_intro);
