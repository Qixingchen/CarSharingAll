...
public class maphttp {
  ...
  static SendRequestWithHttpClient httpsender;
    ...
    public static Map<String, String> testPost(String lng1, String lat1,String lng2, String lat2,String city1,String city2) throws IOException, URISyntaxException {
    	httpsender = new SendRequestWithHttpClient();
         ...
         URI uri = new URI("http://api.map.baidu.com/direction/v1?mode=driving&origin="+  address1 + "&destination="+ address2 +"&origin_region="+city1+"&destination_region="+city2+"&output=json&ak="+"&ak="+ak);    
