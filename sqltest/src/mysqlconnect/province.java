...
public class province {
	 ...
	 */
	public static Map<String, String> testcity(String lng1, String lat1)
		...
		URI uri = new URI("http://api.map.baidu.com/geocoder/v2/?ak=" + ak
				+ "&callback=renderReverse&location=" + address1
				+ "&output=json&pois=1");
	 ...
	 * String> json = province.testcity("24.444111","118.123131");
